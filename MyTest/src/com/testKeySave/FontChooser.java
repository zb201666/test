...
public class FontChooser extends JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7974546923516945871L;
	 ...
	 * 中文预览的字符串
	 */
	private static final String CHINA_STRING = "字体！";
	/**
	 * 英文预览的字符串
	 */
	private static final String ENGLISH_STRING = "ABCDEFG";
	/**
	 * 数字预览的字符串
	 */
...
//		setWindowPos();
	...
	private void init() {
		...
		Document doc = new PlainDocument() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 5678195862512222100L;
	...
	public static void main(String[] args){
		new FontChooser(new Font("宋体",Font.BOLD,12));
	}
}
