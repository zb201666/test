...
//    	}
    ...
    public static void createSimpleTable() throws Exception {
        try (XWPFDocument doc = new XWPFDocument()) {
            ...
            XWPFParagraph p1 = table.getRow(0).getCell(0).getParagraph(null);
            ...
            try (OutputStream out = new FileOutputStream("c:\\simpleTable.docx")) {
                doc.write(out);
            }
        }
    }
...
//                    XWPFParagraph para = cell.getParagraph();
...
//
//            // write the file
//            try (OutputStream out = new FileOutputStream("c:\\styledTable.docx")) {
//                doc.write(out);
//            }
//        }
//    }
